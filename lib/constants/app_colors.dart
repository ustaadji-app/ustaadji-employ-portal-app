...
class AppColors {
  ...
  // ---------------- Dark Theme ----------------
  static const darkBackground = Color(0xFF000000); // Black (70%)
  static const darkPrimary = Color(0xFF3F51B5); // Indigo (20%)
  static const darkSecondary = Color(0xFFFFB74D); // Warm Amber/Orange (10%)
